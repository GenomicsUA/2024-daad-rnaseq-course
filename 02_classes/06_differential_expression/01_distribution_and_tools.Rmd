...
contrast_matrix <- makeContrasts(CIR-HC, levels = design)
...
top_table %>% filter(adj.P.Val < 0.05, abs(logFC) > 1.5) %>% arrange(logFC)
```
...
write.csv(edger_de, here("03_outputs", "06_edgeR_DE_CIRvsHC.csv"))
```
