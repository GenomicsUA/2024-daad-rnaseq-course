...
```{r}
gtf_file <- "C:/Users/anast/Downloads/IntroR/part1R/gencode.v46.annotation.gtf"

```

```{r}
txdb <- makeTxDbFromGFF(gtf_file, format = "gtf")
tx2gene <- select(txdb, keys = keys(txdb, "TXNAME"),
...
```{r}
dir <- "C:/Users/anast/Downloads/IntroR/part1R/kallisto"
...
sampleTable <- data.frame(
  ...
  infection = factor (c("Uninfected", "Uninfected", "SARS-CoV", "SARS-CoV", "SARS-CoV", "SARS-CoV", "SARS-CoV-2", "SARS-CoV-2", "SARS-CoV-2", "SARS-CoV-2")),  
  time = factor(c("0h", "0h", "24h", "24h", "60h", "60h", "24h", "24h", "60h", "60h"))
)
...
```{r}
dds_SARS <- DESeqDataSetFromTximport (txi.kallisto, colData=sampleTable, design= ~ infection_time)
